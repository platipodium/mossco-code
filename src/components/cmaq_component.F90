!> @brief Implementation of an ESMF component model interface for 
!>  the Community Model for Air Quality (CMAQ)
!
!> @import none
...
!   end interface
  ...
  ! variables offered from CMAQ for use by other ESMF components
