...
subroutine message_module_info(messages)
    ...
    call addmessage(messages,'$URL: https://svn.oss.deltares.nl/repos/openearthtools/trunk/programs/SandMudBedModule/03_Fortran/example/example/modules/message_module.f90 $')
