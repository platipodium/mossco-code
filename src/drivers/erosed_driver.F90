...
!This Module needs the following subroutines from delft-example programs:
!eromud.f90
!erosand.f90
!sand_mud.f90
!vanRijn84.f90
...
! Main loop over elements organized in vector form
  do nm = nmlb, nmub !elements
    !if (nm==103) write (*,*) ' initialization:', soursin3d_arguments%sour
    i=  1+ mod((nm-1),inum)
    j=  1+int ((nm-1)/inum)

    !masking:
    if ( mask(i,j) <= 0 ) cycle ! do not run erosed for missing values
...
!         write (0,*) 'step', timestep, 'nm= ', nm, 'relativ_thick', relativ_thick(nm),'h0 ', h0(nm), ' h',h(nm)
          call soursin3d_arguments%set (h (nm),thick0, thick1, sigsed (nm), &
                                  & relative_thickness_of_layers(i,j,kmaxsd), &
...
subroutine allocate_soursin3d (soursin3d_arguments)
  ...
  allocate (soursin3d_arguments%sigsed, soursin3d_arguments%relativ_thick, soursin3d_arguments%r0)
  allocate (soursin3d_arguments%vicmol, soursin3d_arguments%sigmol       , soursin3d_arguments%seddif)
  allocate (soursin3d_arguments%rhosol, soursin3d_arguments%ce_nm        , soursin3d_arguments%ws)
  allocate (soursin3d_arguments%aks   , soursin3d_arguments%sour         , soursin3d_arguments%sink)
...
subroutine deallocate_soursin3d (soursin3d_arguments)
  ...
  deallocate (soursin3d_arguments%sigsed, soursin3d_arguments%relativ_thick, soursin3d_arguments%r0)
  deallocate (soursin3d_arguments%vicmol, soursin3d_arguments%sigmol       , soursin3d_arguments%seddif)
  deallocate (soursin3d_arguments%rhosol, soursin3d_arguments%ce_nm        , soursin3d_arguments%ws)
  deallocate (soursin3d_arguments%aks   , soursin3d_arguments%sour         , soursin3d_arguments%sink)

end subroutine deallocate_soursin3d

!------------------------------------------------------------

subroutine set_soursin3d (soursin3d_arguments, h1, thick0, thick1, sigsed, &
                       &  relativ_thick, r0, vicmol, sigmol, seddif,       &
                       &  rhosol, ce_nm, ws, aks)
