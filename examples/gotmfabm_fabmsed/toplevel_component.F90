module esmf_toplevel_component
  ...
  use gotm_mossco_fabm, only: pelagial_SetServices => SetServices
  use mossco_time
  ...
  subroutine Initialize(gridComp, importState, exportState, parentClock, rc)
    ...
    write(componentnames(1),'(A,I1)') 'GOTMFABM'
    write(componentnames(i),'(A,I1)') 'FABMSED'
    do i=1,n
    ...
    call ESMF_AttributeSet(childComponents(2),couplingnames(2),couplinghours(2),rc=rc)
