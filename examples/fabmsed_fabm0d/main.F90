!> This computer program is part of MOSSCO; main.F90 is the main program to
!> drive an example ESMF/FABM0D/FABM-sediment coupling 
! 
!> @copyright Copyright (C) 2013 Carsten Lemmen, Helmholtz-Zentrum Geesthacht
!
