...
!     TODO: clock provided during Create() seems to be not recognized?!
    ...
    do phase = 1,2
      ...
      if (gridCompPhaseCountList( 1)>= phase .or. gridCompPhaseCountList( 2)>= phase) then
        ...
        write(message,"(A)") trim(myName)//" linking "//trim(gridCompNameList(2))//"Export to "//trim(gridCompNameList(1))//"Import"
        ...
        write(message,"(A)") trim(myName)//" linking "//trim(gridCompNameList(1))//"Import to "//trim(gridCompNameList(2))//"Export"
        call ESMF_LogWrite(trim(message), ESMF_LOGMSG_INFO)
...
#define ESMF_METHOD "Run"
  subroutine Run(gridComp, importState, exportState, parentClock, rc)
    ...
    call ESMF_CplCompRun(cplCompList(1), importState=gridImportStateList(2), &
