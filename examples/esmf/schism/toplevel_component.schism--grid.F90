...
!> the call 'python /gpfs/home/lemmen/devel/mossco/code/examples/generic/create_coupling.py /gpfs/home/lemmen/devel/mossco/code/examples/esmf/schism/schism--grid.yaml'
!>
...
!     TODO: clock provided during Create() seems to be not recognized?!
    ...
    do phase = 1,2
      ...
      if (gridCompPhaseCountList( 1)>= phase .or. gridCompPhaseCountList( 2)>= phase) then
      endif

      !! calling init of regrid_togrid
      !! connecting schismExport to schism_grid_outputImport
      if (gridCompPhaseCountList( 2)>= phase .or. gridCompPhaseCountList( 1)>= phase) then
      if (cplCompPhaseCountList( 2)>= phase) then
        write(message,"(A,I1,A)") trim(myName)//" "//trim(gridCompNameList(2))//"Export=>"//trim(cplCompNameList(2))//"(initP",phase,")=>"//trim(gridCompNameList(1))//"Import"
...
#define ESMF_METHOD "Run"
  subroutine Run(gridComp, importState, exportState, parentClock, rc)
    ...
    call ESMF_CplCompRun(cplCompList(2), importState=gridImportStateList(2), &
