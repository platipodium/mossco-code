!> @brief Main program for an ESMF coupled system
!
!> This program creates the temporal domain and calls a toplevel esmf component
!
...
! Initialize
   call ESMF_Initialize(defaultLogFileName="ESMF-FABM_ocean_sediment",rc=localrc,&
