...
{'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0.;1.8; 1.;	1; 2;1;'LM'};
  ...
  {'Chl_chl_in_water';'chl';0.2;50; 1;					1; 1;2;'L1'};
 {'Chl_chl_in_water';'chl';0.2;40; 1;					1; 1;2;'L0'};
%  {'Chl_chl_in_water';'chl';0.2;40; 1;					1; 1;2;'L2'};
  {'Chl_chl_in_water';'CHL';0.5;16; 2;					1; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;16; 2;					2; 1;0;'Mi'};
...
%  {'c ODUflux-O2flux';'O2 flux';6;40; 72400; 				7; 1;0;'Mi'};
%  {'c ODUflux-O2flux';'O2 flux';6;45; 72400; 				8; 1;0;'Mi'};
