...
%%  {'Chl_chl_in_water';'CHL';0.5;20; 2;					3; 1;0;'Mi'};
  {'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';5.;120; 1;	3; 1;0;'Mi'};
  {'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';5.;120; 1;	4; 1;0;'Mi'};  %  {'Chl_chl_in_water';'CHL';0.5;20; 2;					4; 1;0;'Mi'};
