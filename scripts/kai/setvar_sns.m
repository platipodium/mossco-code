...
var={
  ...
  {'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0;2.; 15.;	1; 2;1;'L1'};
%  {'Phytplankton_Carbon_phyC_in_water';'PhyC';4;200; 1.0;		1; 1;2;'L1'};
  ...
  {'Chl_chl_in_water';'CHL';0.8;40; 2;					2; 1;0;'M0369'};
...
%   {'Zooplankton_Carbon_zooC_in_water';'ZooC';0;9; 1;			1; 2;1;'LM'};
