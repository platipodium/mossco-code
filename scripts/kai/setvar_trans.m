...
%  {'Phytplankton_Carbon_phyC_in_water';'PhyC';4;200; 1.0;		1; 1;2;'L1'};
  {'Chl_chl_in_water';'CHL';0.5;14; 1;					1; 1;0;'Ti'};
  {'Chl_chl_in_water';'CHL';0.5;14; 1;					2; 1;0;'Ti'};
  {'Chl_chl_in_water';'CHL';0.5;14; 1;					3; 1;0;'Ti'};
  {'Chl_chl_in_water';'CHL';0.5;14; 1;					4; 1;0;'Ti'};
  {'Chl_chl_in_water';'CHL';0.5;14; 1;					5; 1;0;'Ti'};
  {'Chl_chl_in_water';'CHL';0.5;14; 1;					6; 1;0;'Ti'};
%  {'Chl_chl_in_water';'CHL';0.5;14; 1;					7; 1;0;'Ti'};
%  {'Chl_chl_in_water';'CHL';0.5;14; 1;					8; 1;0;'Ti'};
...
%  {'Chl_chl_in_water';'CHL';0.;24; 1;					3; 1;0;'Ti'};
  {'Detritus_Carbon_detC_in_water';'DetC';0.2;30; 1;			9; 1;0;'Ti'};
  {'Detritus_Carbon_detC_in_water';'DetC';0.2;30; 1;			10; 1;0;'Ti'};
%  {'Detritus_Carbon_detC_in_water';'DetC';0.2;30; 1;			11; 1;0;'Ti'};
%  {'Detritus_Carbon_detC_in_water';'DetC';0.2;30; 1;			12; 1;0;'Ti'};
%   {'Detritus_Carbon_detC_in_water';'DetC';0.5;50; 1;			2; 2;0;'T357'};
%  {'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0.1;1.5; 1.;13; 1;0;'Ti'};  %%{'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0.1;1.5; 1.;	14; 1;0;'Ti'};
%{'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0.1;1.5; 1.;	15; 1;0;'Ti'};
%  {'temperature_in_water';'Temp';0;18; 1.;				16; 1;0;'Ti'};
%  {'temperature_in_water';'Temp';0;18; 1.;				17; 1;0;'Ti'};
%  {'temperature_in_water';'Temp';0;18; 1.;				18; 1;0;'Ti'};
%  {'temperature_in_water';'Temp';0;18; 1.;				19; 1;0;'Ti'};
...
nfig0 = nfig;
nfig  = nfig *size(locs,1);  % duplication of figures according to sites
