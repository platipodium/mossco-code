...
declare -a vn=("Chl_chl_in_water"  "Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water" "Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water"   "Detritus_Carbon_detC_in_water" "Detritus_Nitrogen_detN_in_water" "Phytplankton_Carbon_phyC_in_water" "Zooplankton_Carbon_zooC_in_water" "concentration_of_SPM_in_water_001"  "concentration_of_SPM_in_water_002" ) 
# "pPads_in_water" "Virus_C_density_in_cells_vir_in_water"
declare -a vnp=("x_velocity_at_soil_surface" "y_velocity_at_soil_surface" "temperature_in_water" "practical_salinity_in_water" "_datt_in_water" "turbulent_kinetic_energy_at_soil_surface" )
