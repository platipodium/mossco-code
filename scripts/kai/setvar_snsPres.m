...
%  {'Phytplankton_Carbon_phyC_in_water';'PhyC';4;200; 0.3;		1; 1;2;'L1'};
  {'Chl_chl_in_water';'chl';0.5;40; 1;					2; 1;1;'L1'};
...
%  {'Chl_chl_in_water';'chl';0.7;40; 1;					2; 1;1;'L0'};
  ...
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                  1; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                  2; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                  3; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                  4; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                  5; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                  6; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                  7; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                  8; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                  9; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                 10; 1;0;'Mi'};
  {'Chl_chl_in_water';'CHL';0.5;20; 1;                                 11; 1;0;'Mi'};
...
%%    {'c Rub./(PhyC+1E-2)';'fRub';0.1;0.5; 1;				11; 1;0;'Mi'};
%%    {'c Rub./(PhyC+1E-2)';'fRub';0.1;0.5; 1;				12; 1;0;'Mi'};
%%    {'c chl./(PhyC+1E-2)';'Chl2C';0.1;0.5; 1;				13; 1;0;'Mi'};
%%    {'c chl./(PhyC+1E-2)';'Chl2C';0.1;0.5; 1;				14; 1;0;'Mi'};
%%    {'c chl./(PhyC+1E-2)';'Chl2C';0.1;0.5; 1;				15; 1;0;'Mi'};
