...
%%%   {'Chl_chl_in_water';'CHL';0.8;28; 1;					1; 1;1;'L1'};
%%   {'Chl_chl_in_water';'CHL';0.;20; 1;					1; 1;1;'V4'};
%  {'Chl_chl_in_water';'chl';0.2;40; 1;					1; 1;2;'L0'};
%%%   {'Chl_chl_in_water';'CHL';0;15; 5;					1; 1;0;'M1'};
...
%  {'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';1.;70; 1;	3; 1;0;'Mi'};
 {'Detritus_Carbon_detC_in_water';'DetC';0.5;100; 1;			1; 1;1;'L0'};
...
%  {'mole_concentration_of_ammonium_upward_flux_at_soil_surface';'NH4 flux';0;1.; 86400.; 1; 2;1;'LM'};
  ...
  {'c ODUflux-O2flux- 0.000';'O2 flux';5;45; 86400; 			1; 1;0;'Mi'};
...
%  {'denitrification_rate_in_soil';'denit';0;100; 1.0;			1; 3;1;'DC'};
 {'c ODUflux-O2flux';'O2 flux';2;60; 86400;                    1; 2;1;'LM'};
%%%   {'Chl_chl_in_water';'CHL';0;15; 4;					3; 1;0;'M1'};
...
%  {'slow_detritus_C_in_soil';'TOC slow';5E2;5E4; 1.0; 			1; 2;2;'LM'};
  {'detritus-P_in_soil';'soil POP';4E1;2E3; 105.0; 			1; 3;1;'L1'};
  {'mole_concentration_of_phosphate_in_soil';'PO4s';5E2;5E4; 105.0; 	1; 3;1;'LM'};
