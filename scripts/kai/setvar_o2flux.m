...
%  {'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';1.;70; 1;	3; 1;0;'Mi'};
 {'Detritus_Carbon_detC_in_water';'DetC';0;8; 0.1;			1; 1;2;'L0'};
...
%  {'mole_concentration_of_ammonium_upward_flux_at_soil_surface';'NH4 flux';0;1.; 86400.; 1; 2;1;'LM'};
  ...
  {'c ODUflux-O2flux- 0.000';'O2 flux';5;35; 86400; 			1; 1;0;'Mi'};
  {'c ODUflux-O2flux- 0.000';'O2 flux';5;35; 86400;                    2; 1;0;'Mi'};
  {'c ODUflux-O2flux- 0.000';'O2 flux';5;35; 86400;                    3; 1;0;'Mi'};
