...
%	1					2	    3   4   5	6   7	8   9
var={{'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';0;45; 1.0;	1; 1;1;'L3'};
  {'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0;-9; 15;	1; 1;1;'L3'};
  {'Chl_chl_in_water';'CHL';0.5;180; 3;					1; 1;2;'L3'};
  {'Phytplankton_Carbon_phyC_in_water';'PhyC';1;80; 1.0;		1; 1;2;'L3'};
  {'Phytplankton_Nitrogen_phyN_in_water';'PhyN';0;-9; 1.0;		1; 2;3;'N'};
  {'Phytplankton_Phosphorus_phyP_in_water';'PhyP';0;-9; 1.0;		1; 2;3;'N'};
  {'c PhyN./(PhyC+1E-2)';'N:C';0;0.3; 1.0;				1; 2;2;'L3'};
  {'c PhyP./(PhyC+1E-2)';'P:C';0;0.3; 15;				1; 2;2;'L3'};
  {'fraction_of_Rubisco_Rub_in_water';'Rub';0;-9; 1.0;			1; 1;3;'N'};
  {'c Rub./(PhyC+1E-2)';'fRub';0;1.; 1.0;				1; 1;3;'L3'};
  {'c 0.6*CHL./(PhyC+1E-2)';'fLHC';0;1.; 1.0;				1; 1;3;'L3'};
  {'c 1-(Rub+0.6*CHL)./(PhyC+1E-2)';'fNut';0;1.; 1.0;			1; 1;3;'L3'};
  {'Zooplankton_Carbon_zooC_in_water';'ZooC';0;7.; 1.0;			1; 1;4;'L3'};
%  {'Si-uptake_activity__aVSi_in_water';'att2';0;0.2; 1.0;		1; 2;4;'L3'};
...
%  {'denitrification_rate_in_soil';'denit';0;100; 1.0;			1; 3;3;'P049'};
  ...
  {'fast_detritus_C_in_soil';'TOC fast';3E3;7E4; 1.0; 			1; 2;3;'LM'};
  ...
  {'Detritus_Carbon_detC_in_water';'DetC';0.1;30; 1.0;			1; 2;4;'L3'};
  {'Detritus_Phosphorus_detP_in_water';'DetP';0.1;80; 100.0;		1; 2;4;'L3'};
