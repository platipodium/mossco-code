...
%	1					2	    3   4   5	6   7	8   9
var={{'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';0;20; 1.0;	1; 1;1;'L9'};
  {'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0;-9; 15;	1; 1;1;'L9'};
  {'Chl_chl_in_water';'CHL';0.4;80; 3;					1; 1;2;'L9'};
...
%  {'Detritus_Carbon_detC_in_water';'DetC';0.1;30; 1.0;			1; 2;4;'L9'};
