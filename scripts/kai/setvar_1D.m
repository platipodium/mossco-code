...
var={{'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';0;40; 1.0;	1; 1;1;'L9'};
  {'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0;1.8; 1;	1; 1;3;'L9'};
  ...
  {'c PhyP./(PhyC+1E-2)';'P:C';0;0.25; 16;				1; 2;1;'LM'};
...
%  {'c 1-(Rub+0.6*CHL)./(PhyC+1E-2)';'fNut';0;1.; 0.5;			1; 1;3;'L9'};
  {'Zooplankton_Carbon_zooC_in_water';'ZooC';0;9.; 1.0;			1; 2;2;'LM'};
