...
var={{'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';0;40; 1.0;	1; 1;1;'L2'};
  {'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0;-9; 15;	1; 1;1;'L2'};
  {'Chl_chl_in_water';'CHL';0.1;120; 3;					1; 1;2;'L2'};
  {'Phytplankton_Carbon_phyC_in_water';'PhyC';1;80; 1.0;		1; 1;2;'L2'};
  {'Phytplankton_Nitrogen_phyN_in_water';'PhyN';0;-9; 1.0;		1; 2;3;'N'};
  {'Phytplankton_Phosphorus_phyP_in_water';'PhyP';0;-9; 1.0;		1; 2;3;'N'};
  {'c PhyN./(PhyC+1E-2)';'N:C';0.06;0.5; 1.0;				1; 2;2;'L2'};
  {'c PhyP./(PhyC+1E-2)';'P:C';0;0.3; 15;				1; 2;2;'L2'};
  {'Phytoplankton_Exudation_Loss_Rate__phyELR_in_water';'resp';0;0.5; 1.;1; 2;3;'L2'};
  {'Phytoplankton_C_Uptake_Rate__phyUR_in_water';'GPP';0;0.27; 1.;1; 2;3;'L2'};
%  {'dtheta_dt_due_to_flex_theta__fac4_in_water';'fZm';0;1.; 	1.;	1; 2;3;'L2'};
  {'Zooplankton_Mortality_rate_in_water';'Zmort';0;0.27; 	1.;	1; 2;3;'L2'};
  {'fraction_of_Rubisco_Rub_in_water';'Rub';0;-9; 1.0;			1; 1;3;'N'};
  {'c Rub./(PhyC+1E-2)';'fRub';0.;0.4; 1.0;				1; 1;3;'L2'};
%  {'c 0.6*CHL./(PhyC+1E-2)';'fLHC';0;1.; 1.0;				1; 1;3;'L2'};
  {'c 1-(Rub+0.6*CHL)./(PhyC+1E-2)';'fNut';0;1.; 0.5;			1; 1;3;'L2'};
  {'Zooplankton_Carbon_zooC_in_water';'ZooC';0;9.; 1.0;			1; 1;2;'L2'};
%  {'Si-uptake_activity__aVSi_in_water';'att2';0;0.2; 1.0;		1; 2;4;'L2'};
...
%%  {'c O_2flux+ODUflux';'tO2 flux';-6;0; -0.1; 				1; 2;1;'LM'};
  {'N-uptake_activity__aVN_in_water';'aVN';0;1.; 1.; 				1; 2;1;'L2'};
  {'P-uptake_activity__aVP_in_water';'aVP';0;1.; 1.; 				1; 2;1;'L2'};
...
%  {'mole_concentration_of_phosphate_in_soil';'PO4';5E2;5E4; 90; 	1; 2;3;'LM'};
  {'Detritus_Carbon_detC_in_water';'DetC';0.;-9; 1.0;			1; 1;1;'L2'};
%  {'Detritus_Phosphorus_detP_in_water';'DetP';0.1;80; 100.0;		1; 2;4;'L2'};
