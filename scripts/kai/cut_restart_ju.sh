...
#for p in $(seq -f $fg 0 1 $[$ncpu-1]); do ncap -O -s "Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water=0.5+0.25*Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water)" tmp.$p.nc tmp.$p.nc; done
