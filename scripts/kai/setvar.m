...
%	1					2	    3   4   5	6   7	8   9
var={{'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';0;30; 1.0;	1; 1;1;'LM'};
  ...
  {'detritus-P_in_soil';'POP';5E2;5E4; 10; 			1; 3;2;'LM'};
  {'mole_concentration_of_phosphate_in_soil';'PO4';5E2;5E4; 10; 			1; 3;2;'LM'};
