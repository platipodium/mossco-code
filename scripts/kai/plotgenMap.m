...
show_data=1; Is1D=0; IsNOAH=0; vt{1}='';
...
%;'_a_chl0.02';'_a_minfr0.12';'_syn_nut2.';'_rFast0.03';'_vir_mu-0.02';'_mort_zoo0.008';
%'_syn_nut4.';'_vS_phy7.';'_vir_mu-0.04';'_vir_mu-0.5';
%'_mort_zoo0.016';'_vir_mu-0.02';'_a_minfr0.3';'_zeta_CN2.5';
tags ={'_syn_nut4.5';'_syn_nut-4.5';}; %'_a2';'1';'_att';'';'_30_0';'_30_1';'_del2';'';'_genMeth12';
...
%%spath='/data/wirtz/sns/cut';
 ...
 %%   ncol = 2; nrow = 1; 	% number of columns in fig
    ...
    setvar_snsMap %Pres Data defines variables to show - and where/how to do it %setvar  
  end
end
...
%% open all figures
for np=1:nfig+nfigm, figure(np); set(gcf,'Position',[0 0 1680 850],'Visible','on','Color','w'); end
oldfig=-np; 
...
t0 = datenum('2003-07-12','yyyy-mm-dd')-1;
t1 = datenum('2003-07-31','yyyy-mm-dd')-1;
%%t1 = datenum('2004-10-05','yyyy-mm-dd')-1;
...
for np=1:nfig+nfigm+nfigc
  ...
  set(gcf,'PaperPositionMode','auto', 'InvertHardCopy', 'off','Visible','on');%,'Visible','off'
