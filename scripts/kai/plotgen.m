...
spath  ='/home/wirtz/cut_68';%spath  ='/data/wirtz/sns_0/cut_29';
%ncfile = fullfile(spath,['cut_29_' tag '.nc']);
%spath  ='/home/wirtz/mossco/mossco-setups/helgoland/mossco_1d';%
%spath  ='/home/wirtz';

%tags={'102';'104';'132';'134';'82';'84';}; 
tags={'_00';'_22';}; 
%tags={'_0';'_1';};%'_0';tags={'_4';};%'_2';'_3';
%tags={'ef';};%'_0';'_1';
ntags=length(tags);
%% check for tag file
...
%  ncfile = fullfile(spath,['hr' tag '/mossco_1d.nc']);
 ncfile = fullfile(spath,['cut_68' tag '.nc']);
 read_nc_time_layers
 t0=time(1); t1=time(end);
 t0 = datenum('2001-03-01','yyyy-mm-dd')-1;
% t1 = datenum('2002-12-01','yyyy-mm-dd')-1;
