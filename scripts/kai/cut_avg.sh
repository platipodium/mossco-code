...
tg='time,doy,getmGrid2D_getm_y,getmGrid2D_getm_x,getmGrid3D_getm_y,getmGrid3D_getm_x,getmGrid2D_getm_Y,getmGrid2D_getm_X,getmGrid3D_getm_Y,getmGrid3D_getm_X,layer_height_in_water'
...
#        echo $tg,$ts
  ...
  ncks -F -O -v $tg,$ts \
	-d getmGrid2D_getm_x,1,,${dlon} \
	-d getmGrid2D_getm_y,1,,${dlat} \
	-d getmGrid3D_getm_x,1,,${dlon} \
	-d getmGrid3D_getm_y,1,,${dlat} \
	-d getmGrid3D_getm_z,1,,${dz} \
