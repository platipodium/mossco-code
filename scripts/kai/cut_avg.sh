...
declare -a vn=("Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water" "Chl_chl_in_water" "Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water"  "Phytplankton_Phosphorus_phyP_in_water" "Phytplankton_Nitrogen_phyN_in_water"   "mole_concentration_of_nitrate_in_soil" "Detritus_Carbon_detC_in_water" "Phytplankton_Carbon_phyC_in_water" "denitrification_rate_in_soil" 
"dissolved_oxygen_upward_flux_at_soil_surface" "layer_height_in_soil")
# "Detritus_Phosphorus_detP_in_water""dissolved_oxygen_in_soil" "Phytplankton_Phosphorus_phyP_in_water" "Phytplankton_Nitrogen_phyN_in_water" "fraction_of_Rubisco_Rub_in_water""detritus-P_in_soil" "temperature_in_water""Phytplankton_Phosphorus_phyP_in_water" "Phytplankton_Nitrogen_phyN_in_water"    "N\:C_ratio__QN_in_water" "P\:C_ratio__QP_in_water" "Rubisco_fract._allocation__fracR_in_water" "chlorophyll_to_carbon_ratio_in_water" "water_depth_at_soil_surface" "denitrification_rate_in_soil" "mole_concentration_of_nitrate_in_soil  "mole_concentration_of_phosphate_in_soil"
# 
...
dz=13         # slicing of vertical dimension; 18 retrieves upper and lower layer for N=20
# ---------------------
...
#        echo $tg,$ts
  ...
  ncks -F -O -v $tg,$ts \
	...
	-d time,$Nstart,$N $fname $outname2
...
#    ncap -O -s "N2flux=dissolved_oxygen_upward_flux_at_soil_surface"  $outname2 $outname
  ...
  cd $outdir
  for na in $(seq -f "%02g" 1 $nslice); do #Number of years in the file
