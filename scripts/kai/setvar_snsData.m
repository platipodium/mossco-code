...
var={
  {'Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water';'DIN';1.4;70; 1.0;	1; 1;1;'L1'};
{'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0.;1.7; 1.;	1; 2;1;'L1'};
  {'Phytplankton_Carbon_phyC_in_water';'PhyC';4;200; 1.0;		1; 1;2;'N'};
  {'Chl_chl_in_water';'chl';0.6;45; 1;					1; 1;2;'L1'};
%  {'Chl_chl_in_water';'chl';0.2;40; 1;					1; 1;2;'L2'};
 ...
 % {'Chl_chl_in_water';'CHL';0.5;20; 2;                                  4; 1;0;'Mi'};
%  {'Detritus_Carbon_detC_in_water';'DetC';0;150; 1;			4; 1;0;'Mi'};
%  {'Detritus_Carbon_detC_in_water';'DetC';0;150; 1;			5; 1;0;'Mi'};
%  {'Detritus_Carbon_detC_in_water';'DetC';0;150; 1;			6; 1;0;'Mi'};
%%  {'Chl_chl_in_water';'CHL';0.5;20; 2;                                  3; 1;0;'Mi'};
 %{'denitrification_rate_in_soil';'Denit';0.;40; 1;                      3; 1;0;'Mi'};
%% {'Chl_chl_in_water';'CHL';0.5;16; 2;					3; 1;0;'Mi'};
%  {'Chl_chl_in_water';'CHL';0.5;16; 2;					4; 1;0;'Mi'};
...
%  {'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0.2;2.2; 2.;5; 1;0;'Mi'};
%  {'Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water';'DIP';0.2;2.2; 2.;6; 1;0;'Mi'};
   {'Zooplankton_Carbon_zooC_in_water';'ZooC';0;14; 1;			1; 2;2;'LM'};
   {'Detritus_Carbon_detC_in_water';'DetC';0;8; 0.05;			1; 2;2;'L0'};
...
%% {'c ODUflux-O2flux';'O2 flux';3;40; 72400; 				5; 1;0;'Mi'};
%  {'c ODUflux-O2flux';'O2 flux';10;45; 86400; 				9; 1;0;'Mi'};
  {'c ODUflux-O2flux';'O2 flux';5;35; 86400; 				1; 1;2;'LM'};
...
%%  {'detritus-P_in_soil';'POP';2E-1;5E2; 1.0; 			1; 1;3;'L0'};
