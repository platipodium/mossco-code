...
declare -a vn=("Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water" "Chl_chl_in_water" "Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water"  "Phytplankton_Phosphorus_phyP_in_water" "Phytplankton_Nitrogen_phyN_in_water"   "mole_concentration_of_nitrate_in_soil" "Detritus_Carbon_detC_in_water" "Phytplankton_Carbon_phyC_in_water" "denitrification_rate_in_soil" "Zooplankton_Carbon_zooC_in_water" "dissolved_oxygen_upward_flux_at_soil_surface" "layer_height_in_soil")
...
for p in $(seq -f "%03g" $n1 $dn $nproc); do
  fname=${prefix}$p'.nc'
