...
declare -a vn=("Dissolved_Inorganic_Nitrogen_DIN_nutN_in_water" "Dissolved_Inorganic_Phosphorus_DIP_nutP_in_water" "Chl_chl_in_water" "Phytplankton_Carbon_phyC_in_water" "Detritus_Carbon_detC_in_water" "Zooplankton_Carbon_zooC_in_water")
# "detritus-P_in_soil" "mole_concentration_of_phosphate_in_soil" "Phytplankton_Phosphorus_phyP_in_water" "Phytplankton_Nitrogen_phyN_in_water""Phytplankton_Carbon_phyC_in_water"  "fraction_of_Rubisco_Rub_in_water"  "Rubisco_fract._allocation__fracR_in_water" "mole_concentration_of_phosphate_in_soil"
...
tg='time,doy,getmGrid2D_getm_lat,getmGrid2D_getm_lon,getmGrid3D_getm_lat,getmGrid3D_getm_lon'
#,getmGrid2D_getm_Y,getmGrid2D_getm_X,getmGrid3D_getm_Y,getmGrid3D_getm_X'
ts=$model${vn[0]}
for (( i=1; i<${#vn[@]}; i++ )) do
  ts=$ts','${vn[$i]}
done # i
