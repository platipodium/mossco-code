...
timedim='-d time,389' #Sep 8 2003
#vertdimW='-d getmGrid3D_getm_3,0,1,29'
...
Hvars='water_depth_at_soil_surface,dissolved_oxygen_upward_flux_at_soil_surface'
