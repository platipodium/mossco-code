...
def find_coordinate_variables(filename):
...
def stitch_all_tiles(pattern, outfile):
    ...
    alon, alat = find_coordinate_variables(files[0])
    proceed()
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        prefix = u"/Users/lemmen/devel/mossco/setups/sns/mossco_gfbfrr"
    ...
    stitch_all_tiles(pattern, outfile)
